 ...
 * SH                   12 Jan. 20  Add PIC32MX features.  Tested OK
 * SH                   10  Feb 2021 Got rid of peripheral lib. Replace INTEnableSystemMultiVectoredInt()
 *                                  by INTCONbits.MVEC=1; No more library needed.  Needs only sys/attribs.h
 * 
 * The original file is : 247-511-VA Microcontroller Applications\Projects\common
 *
 *
********************************************************************/
#define __TICK_C
...
void __ISR( _TIMER_1_VECTOR, IPL1SOFT) T1InterruptHandler( void){
	// Increment internal high tick counter
	dwInternalTicks++;
